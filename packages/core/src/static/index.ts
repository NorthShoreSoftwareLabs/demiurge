...
async function loadRouteModules(
  ...
  // SAFETY: Object.fromEntries builds a record whose values are the loaded route modules. The cast labels the keys and values.
...
async function readPreviousOutputFiles(outDir: string) {
  try {
    ...
    // SAFETY: the manifest file is JSON that the static build serialized. The cast describes its expected shape before validation.
