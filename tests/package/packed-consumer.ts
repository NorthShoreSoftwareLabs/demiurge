...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      `import { inspectStaticOutput, verifyStaticOutput, verifyStaticProvider } from "@demiurgejs/core/static/testing";`,
      ...
      `for (const [name, value] of Object.entries({ createApplicationTest, createEdgeAssetHandler, createEdgeRequestHandler, createEncryptedCookieSession, createKvCacheStore, createKvSessionStore, createMemorySessionStore, createMutationAction, createNodeServer, createRedisCacheStore, createRedisSessionStore, createRequestHandler, createSessionManager, createSignedCookieSession, defineConfig, demiurge, generateStaticOutput, hydrateFileRouter, inspectStaticOutput, mutation, MutationSubmit, MutationValidationError, page, unstable_createRouteManifest, useMutationAction, verifyAdapterContract, verifyCacheStoreContract, verifyDeploymentContract, verifySessionStoreContract, verifyStaticOutput, verifyStaticProvider })) {`,
