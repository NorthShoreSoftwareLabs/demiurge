...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      `import { assertDocument, assertSecurity, createApplicationTest } from "@demiurgejs/core/testing";`,
      ...
      `for (const [name, value] of Object.entries({ createApplicationTest, createEdgeAssetHandler, createEdgeRequestHandler, createEncryptedCookieSession, createKvCacheStore, createKvSessionStore, createMemorySessionStore, createMutationAction, createNodeServer, createRedisCacheStore, createRedisSessionStore, createRequestHandler, createSessionManager, createSignedCookieSession, createStaticOutputTest, defineConfig, demiurge, generateStaticOutput, hydrateFileRouter, inspectStaticOutput, mutation, MutationSubmit, MutationValidationError, page, readStaticOutputManifest, unstable_createRouteManifest, useMutationAction, verifyAdapterContract, verifyCacheStoreContract, verifyDeploymentContract, verifySessionStoreContract, verifyStaticOutput, verifyStaticProvider })) {`,
