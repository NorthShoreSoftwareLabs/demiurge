...
try {
  ...
  writeFileSync(
    ...
    [
      `import { createEncryptedCookieSession, createMemoryCacheStore, createMemorySessionStore, createMutationAction, createRequestHandler, createSecurityHeaders, createSignedCookieSession, hydrateFileRouter, mutation, mutationInput, MutationSubmit, MutationValidationError, page, security, useMutationAction } from "@demiurgejs/core";`,
      ...
      `for (const [name, value] of Object.entries({ createEdgeAssetHandler, createEdgeRequestHandler, createEncryptedCookieSession, createKvCacheStore, createMemorySessionStore, createMutationAction, createNodeServer, createRedisCacheStore, createRequestHandler, createSignedCookieSession, demiurge, generateStaticOutput, hydrateFileRouter, mutation, MutationSubmit, MutationValidationError, page, unstable_createRouteManifest, useMutationAction, verifyAdapterContract, verifyCacheStoreContract, verifySessionStoreContract })) {`,
