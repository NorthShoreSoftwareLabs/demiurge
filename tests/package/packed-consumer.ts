...
try {
  ...
  writeFileSync(
    ...
    [
      `import { createMemoryCacheStore, createMemorySessionStore, createMutationAction, createRequestHandler, createSecurityHeaders, hydrateFileRouter, mutation, mutationInput, MutationSubmit, MutationValidationError, page, security, useMutationAction } from "@demiurgejs/core";`,
