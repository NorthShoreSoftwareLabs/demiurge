...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      `for (const [name, value] of Object.entries({ createEdgeAssetHandler, createEdgeRequestHandler, createNodeServer, createRequestHandler, demiurge, generateStaticOutput, hydrateFileRouter, page, unstable_createRouteManifest, verifyAdapterContract, verifyCacheStoreContract })) {`,
