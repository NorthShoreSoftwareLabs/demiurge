...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      `for (const [name, value] of Object.entries({ createApplicationTest, createEdgeAssetHandler, createEdgeRequestHandler, createEncryptedCookieSession, createKvCacheStore, createKvSessionStore, createMemorySessionStore, createMutationAction, createNodeServer, createRedisCacheStore, createRedisSessionStore, createRequestHandler, createSessionManager, createSignedCookieSession, createStaticOutputTest, createTestClock, createTestRequest, defineConfig, demiurge, generateStaticOutput, hydrateFileRouter, inspectStaticOutput, mutation, MutationSubmit, MutationValidationError, page, readStaticOutputManifest, unstable_createRouteManifest, useMutationAction, verifyAdapterContract, verifyCacheStoreContract, verifyDeploymentContract, verifySessionStoreContract, verifyStaticOutput, verifyStaticProvider })) {`,
